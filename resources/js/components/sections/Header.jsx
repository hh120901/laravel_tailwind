		...
		<div className='border-b-2 border-gray-500'>
			<div className="bg-neutral-900">
				<div className="container mx-auto 2xl:max-w-[1400px]">
					<div className="site-url flex justify-center">
						<h2 className='py-5 text-white text-3xl font-semibold tracking-widest'>
							Isiro Landing Page
						</h2>
					</div>
				</div>
			...
			<div className="container mx-auto 2xl:max-w-[1400px]">	
				<nav className='xl:mx-16 xl:space-x-16 space-x-6 flex justify-center py-4'>
					...
					<NavLink className='nav-item hover:scale-110' activeClassName='active' to='/wallet'>Wallet</NavLink>
					<NavLink className='nav-item hover:scale-110' activeClassName='active' to='/plan'>Plan</NavLink>
			...
			<div className="container mx-auto 2xl:max-w-[1400px] px-3">
				<div className='flex items-center justify-between py-5'>
					<div className="logo font-semibold">
						<h2 className='tracking-widest leading-5'>M R . I S I R O</h2>
					</div>
					<div>
